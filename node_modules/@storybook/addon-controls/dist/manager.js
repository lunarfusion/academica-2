...
`&&(inLineComment=!1)),!inBlockComment&&!inLineComment&&(newCode+=code[i2]);else newCode=code;return newCode};(0, import_memoizerific2.default)(1e4)(code=>removeCodeComments(code).replace(/\n\s*/g,"").trim());createContext({sources:{}});var{document:document2}=globalThis;function navigate(context,url){context.channel.emit(NAVIGATE_URL,url);}components.a;var SUPPORTED_MDX_HEADERS=["h1","h2","h3","h4","h5","h6"],OcticonHeaders=SUPPORTED_MDX_HEADERS.reduce((acc,headerType)=>({...acc,[headerType]:styled(headerType)({"& svg":{position:"relative",top:"-0.1em",visibility:"hidden"},"&:hover svg":{visibility:"visible"}})}),{}),OcticonAnchor=styled.a(()=>({float:"left",lineHeight:"inherit",paddingRight:"10px",marginLeft:"-24px",color:"inherit"})),HeaderWithOcticonAnchor=({as,id,children,...rest})=>{let context=useContext(DocsContext),OcticonHeader=OcticonHeaders[as],hash=`#${id}`;return React15__default__default.createElement(OcticonHeader,{id,...rest},React15__default__default.createElement(OcticonAnchor,{"aria-hidden":"true",href:hash,tabIndex:-1,target:"_self",onClick:event=>{document2.getElementById(id)&&navigate(context,hash);}},React15__default__default.createElement(LinkIcon,null)),children)},HeaderMdx=props=>{let{as,id,children,...rest}=props;if(id)return React15__default__default.createElement(HeaderWithOcticonAnchor,{as,id,...rest},children);let Component4=as,{as:omittedAs,...withoutAs}=props;return React15__default__default.createElement(Component4,{...nameSpaceClassNames(withoutAs,as)})};SUPPORTED_MDX_HEADERS.reduce((acc,headerType)=>({...acc,[headerType]:props=>React15__default__default.createElement(HeaderMdx,{as:headerType,...props})}),{});var DescriptionType=(DescriptionType2=>(DescriptionType2.INFO="info",DescriptionType2.NOTES="notes",DescriptionType2.DOCGEN="docgen",DescriptionType2.AUTO="auto",DescriptionType2))(DescriptionType||{});__toESM(require_js());styled.div(({theme})=>({width:"10rem","@media (max-width: 768px)":{display:"none"}}));styled.div(({theme})=>({position:"fixed",bottom:0,top:0,width:"10rem",paddingTop:"4rem",paddingBottom:"2rem",overflowY:"auto",fontFamily:theme.typography.fonts.base,fontSize:theme.typography.size.s2,WebkitFontSmoothing:"antialiased",MozOsxFontSmoothing:"grayscale",WebkitTapHighlightColor:"rgba(0, 0, 0, 0)",WebkitOverflowScrolling:"touch","& *":{boxSizing:"border-box"},"& > .toc-wrapper > .toc-list":{paddingLeft:0,borderLeft:`solid 2px ${theme.color.mediumlight}`,".toc-list":{paddingLeft:0,borderLeft:`solid 2px ${theme.color.mediumlight}`,".toc-list":{paddingLeft:0,borderLeft:`solid 2px ${theme.color.mediumlight}`}}},"& .toc-list-item":{position:"relative",listStyleType:"none",marginLeft:20,paddingTop:3,paddingBottom:3},"& .toc-list-item::before":{content:'""',position:"absolute",height:"100%",top:0,left:0,transform:"translateX(calc(-2px - 20px))",borderLeft:`solid 2px ${theme.color.mediumdark}`,opacity:0,transition:"opacity 0.2s"},"& .toc-list-item.is-active-li::before":{opacity:1},"& .toc-list-item > a":{color:theme.color.defaultText,textDecoration:"none"},"& .toc-list-item.is-active-li > a":{fontWeight:600,color:theme.color.secondary,textDecoration:"none"}}));styled.p(({theme})=>({fontWeight:600,fontSize:"0.875em",color:theme.textColor,textTransform:"uppercase",marginBottom:10}));var Heading2=({children,disableAnchor,...props})=>{if(disableAnchor||typeof children!="string")return React15__default__default.createElement(H2,null,children);let tagID=children.toLowerCase().replace(/[^a-z0-9]/gi,"-");return React15__default__default.createElement(HeaderMdx,{as:"h2",id:tagID,...props},children)};styled(Heading2)(({theme})=>({fontSize:`${theme.typography.size.s2-1}px`,fontWeight:theme.typography.weight.bold,lineHeight:"16px",letterSpacing:"0.35em",textTransform:"uppercase",color:theme.textMutedColor,border:0,marginBottom:"12px","&:first-of-type":{marginTop:"56px"}}));var slideIn=keyframes({from:{transform:"translateY(40px)"},to:{transform:"translateY(0)"}}),highlight=keyframes({from:{background:"var(--highlight-bg-color)"},to:{}}),Container=styled.div({containerType:"size",position:"sticky",bottom:0,height:39,overflow:"hidden",zIndex:1}),Bar2=styled(Bar$1)(({theme})=>({"--highlight-bg-color":theme.base==="dark"?"#153B5B":"#E0F0FF",display:"flex",flexDirection:"row-reverse",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:6,padding:"6px 10px",animation:`${slideIn} 300ms, ${highlight} 2s`,background:theme.background.bar,borderTop:`1px solid ${theme.appBorderColor}`,fontSize:theme.typography.size.s2,"@container (max-width: 799px)":{flexDirection:"row",justifyContent:"flex-end"}})),Info=styled.div({display:"flex",flex:"99 0 auto",alignItems:"center",marginLeft:10,gap:6}),Actions=styled.div(({theme})=>({display:"flex",flex:"1 0 0",alignItems:"center",gap:2,color:theme.color.mediumdark,fontSize:theme.typography.size.s2})),Label5=styled.div({"@container (max-width: 799px)":{lineHeight:0,textIndent:"-9999px","&::after":{content:"attr(data-short-label)",display:"block",lineHeight:"initial",textIndent:"0"}}}),ModalInput=styled(Form.Input)(({theme})=>({"::placeholder":{color:theme.color.mediumdark},"&:invalid:not(:placeholder-shown)":{boxShadow:`${theme.color.negative} 0 0 0 1px inset`}})),SaveStory=({saveStory,createStory,resetArgs})=>{let inputRef=React15__default__default.useRef(null),[saving,setSaving]=React15__default__default.useState(!1),[creating,setCreating]=React15__default__default.useState(!1),[storyName,setStoryName]=React15__default__default.useState(""),[errorMessage,setErrorMessage]=React15__default__default.useState(null),onSaveStory=async()=>{saving||(setSaving(!0),await saveStory().catch(()=>{}),setSaving(!1));},onShowForm=()=>{setCreating(!0),setStoryName(""),setTimeout(()=>inputRef.current?.focus(),0);},onChange=e=>{let value=e.target.value.replace(/^[^a-z]/i,"").replace(/[^a-z0-9-_ ]/gi,"").replaceAll(/([-_ ]+[a-z0-9])/gi,match=>match.toUpperCase().replace(/[-_ ]/g,""));setStoryName(value.charAt(0).toUpperCase()+value.slice(1));};return React15__default__default.createElement(Container,{id:"save-from-controls"},React15__default__default.createElement(Bar2,null,React15__default__default.createElement(Actions,null,React15__default__default.createElement(WithTooltip,{as:"div",hasChrome:!1,trigger:"hover",tooltip:React15__default__default.createElement(TooltipNote,{note:"Save changes to story"})},React15__default__default.createElement(IconButton,{"aria-label":"Save changes to story",disabled:saving,onClick:onSaveStory},React15__default__default.createElement(CheckIcon,null),React15__default__default.createElement(Label5,{"data-short-label":"Save"},"Update story"))),React15__default__default.createElement(WithTooltip,{as:"div",hasChrome:!1,trigger:"hover",tooltip:React15__default__default.createElement(TooltipNote,{note:"Create new story with these settings"})},React15__default__default.createElement(IconButton,{"aria-label":"Create new story with these settings",onClick:onShowForm},React15__default__default.createElement(AddIcon,null),React15__default__default.createElement(Label5,{"data-short-label":"New"},"Create new story"))),React15__default__default.createElement(WithTooltip,{as:"div",hasChrome:!1,trigger:"hover",tooltip:React15__default__default.createElement(TooltipNote,{note:"Reset changes"})},React15__default__default.createElement(IconButton,{"aria-label":"Reset changes",onClick:()=>resetArgs()},React15__default__default.createElement(UndoIcon,null),React15__default__default.createElement("span",null,"Reset")))),React15__default__default.createElement(Info,null,React15__default__default.createElement(Label5,{"data-short-label":"Unsaved changes"},"You modified this story. Do you want to save your changes?")),React15__default__default.createElement(Modal,{width:350,open:creating,onOpenChange:setCreating},React15__default__default.createElement(Form,{onSubmit:async event=>{if(event.preventDefault(),!saving)try{setErrorMessage(null),setSaving(!0),await createStory(storyName.replace(/^[^a-z]/i,"").replaceAll(/[^a-z0-9]/gi,"")),setCreating(!1),setSaving(!1);}catch(e){setErrorMessage(e.message),setSaving(!1);}},id:"create-new-story-form"},React15__default__default.createElement(Modal.Content,null,React15__default__default.createElement(Modal.Header,null,React15__default__default.createElement(Modal.Title,null,"Create new story"),React15__default__default.createElement(Modal.Description,null,"This will add a new story to your existing stories file.")),React15__default__default.createElement(ModalInput,{onChange,placeholder:"Story export name",readOnly:saving,ref:inputRef,value:storyName}),React15__default__default.createElement(Modal.Actions,null,React15__default__default.createElement(Button,{disabled:saving||!storyName,size:"medium",type:"submit",variant:"solid"},"Create"),React15__default__default.createElement(Modal.Dialog.Close,{asChild:!0},React15__default__default.createElement(Button,{disabled:saving,size:"medium",type:"reset"},"Cancel"))))),errorMessage&&React15__default__default.createElement(Modal.Error,null,errorMessage))))};var ADDON_ID="addon-controls",PARAM_KEY="controls";var clean=obj=>Object.entries(obj).reduce((acc,[key,value])=>value!==void 0?Object.assign(acc,{[key]:value}):acc,{}),AddonWrapper=styled.div({display:"grid",gridTemplateRows:"1fr 39px",height:"100%",maxHeight:"100vh",overflowY:"auto"}),ControlsPanel=({saveStory,createStory})=>{let[isLoading,setIsLoading]=useState(!0),[args,updateArgs,resetArgs,initialArgs]=useArgs(),[globals]=useGlobals(),rows=useArgTypes(),{expanded,sort,presetColors,disableSaveFromUI=!1}=useParameter(PARAM_KEY,{}),{path,previewInitialized}=useStorybookState();useEffect(()=>{previewInitialized&&setIsLoading(!1);},[previewInitialized]);let hasControls=Object.values(rows).some(arg=>arg?.control),withPresetColors=Object.entries(rows).reduce((acc,[key,arg])=>{let control=arg?.control;return typeof control!="object"||control?.type!=="color"||control?.presetColors?acc[key]=arg:acc[key]={...arg,control:{...control,presetColors}},acc},{}),hasUpdatedArgs=useMemo(()=>!!args&&!!initialArgs&&!dequal(clean(args),clean(initialArgs)),[args,initialArgs]);return React15__default__default.createElement(AddonWrapper,null,React15__default__default.createElement(ArgsTable,{key:path,compact:!expanded&&hasControls,rows:withPresetColors,args,globals,updateArgs,resetArgs,inAddonPanel:!0,sort,isLoading}),hasControls&&hasUpdatedArgs&&global$1.CONFIG_TYPE==="DEVELOPMENT"&&disableSaveFromUI!==!0&&React15__default__default.createElement(SaveStory,{resetArgs,saveStory,createStory}))};function Title2(){let rows=useArgTypes(),controlsCount=Object.values(rows).filter(argType=>argType?.control&&!argType?.table?.disable).length;return React15__default__default.createElement("div",null,React15__default__default.createElement(Spaced,{col:1},React15__default__default.createElement("span",{style:{display:"inline-block",verticalAlign:"middle"}},"Controls"),controlsCount===0?"":React15__default__default.createElement(Badge,{status:"neutral"},controlsCount)))}var stringifyArgs=args=>JSON.stringify(args,(_2,value)=>typeof value=="function"?"__sb_empty_function_arg__":value);addons.register(ADDON_ID,api=>{let channel=addons.getChannel(),saveStory=async()=>{let data=api.getCurrentStoryData();if(data.type!=="story")throw new Error("Not a story");try{let response=await experimental_requestResponse(channel,SAVE_STORY_REQUEST,SAVE_STORY_RESPONSE,{args:stringifyArgs(Object.entries(data.args||{}).reduce((acc,[key,value])=>(dequal(value,data.initialArgs?.[key])||(acc[key]=value),acc),{})),csfId:data.id,importPath:data.importPath});api.addNotification({id:"save-story-success",icon:{name:"passed",color:color.positive},content:{headline:"Story saved",subHeadline:React15__default__default.createElement(React15__default__default.Fragment,null,"Updated story ",React15__default__default.createElement("b",null,response.sourceStoryName),".")},duration:8e3});}catch(error){throw api.addNotification({id:"save-story-error",icon:{name:"failed",color:color.negative},content:{headline:"Failed to save story",subHeadline:error?.message||"Check the Storybook process on the command line for more details."},duration:8e3}),error}},createStory=async name=>{let data=api.getCurrentStoryData();if(data.type!=="story")throw new Error("Not a story");let response=await experimental_requestResponse(channel,SAVE_STORY_REQUEST,SAVE_STORY_RESPONSE,{args:data.args&&stringifyArgs(data.args),csfId:data.id,importPath:data.importPath,name});api.addNotification({id:"save-story-success",icon:{name:"passed",color:color.positive},content:{headline:"Story created",subHeadline:React15__default__default.createElement(React15__default__default.Fragment,null,"Added story ",React15__default__default.createElement("b",null,response.newStoryName)," based on ",React15__default__default.createElement("b",null,response.sourceStoryName),".")},duration:8e3,onClick:({onDismiss})=>{onDismiss(),api.selectStory(response.newStoryId);}});};addons.add(ADDON_ID,{title:Title2,type:types.PANEL,paramKey:PARAM_KEY,render:({active})=>!active||!api.getCurrentStoryData()?null:React15__default__default.createElement(AddonPanel,{active},React15__default__default.createElement(ControlsPanel,{saveStory,createStory}))}),channel.on(SAVE_STORY_RESPONSE,data=>{if(!data.success)return;let story=api.getCurrentStoryData();story.type==="story"&&(api.resetStoryArgs(story),data.payload.newStoryId&&api.selectStory(data.payload.newStoryId));});});
